public class Listing_4_16 {
	public static void main(String[] args) {
		...
		// print the number
		/*This line is good for seeing the number
		 * System.out.println("The random upper case letter of the day is: " + randomUpperCaseLetterNumber);
		 */
		
		// This line lets you see the character.
	...
	public static int makeRandomUpperLetter(){
		...
		// Page 122, bottom of the page, 4.2.5 The random Method
